...
class SoftActorCritic():
    ...
    def __init__(self, args):
        ...
        self.env = ConstTdContinuousCruiseCtrlEnv(time_delay=args.time_delay, train=True, delta=args.delta) 
        self.test_env = ConstTdContinuousCruiseCtrlEnv(time_delay=args.time_delay, train=False, delta=args.delta) 
