		...
		for basic_mdp_state in self.basic_mdp_states:
			for buffer_state in self.buffer_states:
				...
				for action in range(num_actions):
					...
					next_basic_states = self.basic_mdp[query][0] 
					next_basic_states_probs = self.basic_mdp[query][1]
					...
					print(state_action_pair, query, transitions, next_basic_states_probs)
					
					self.mdp[state_action_pair] = (transitions, next_basic_states_probs)
