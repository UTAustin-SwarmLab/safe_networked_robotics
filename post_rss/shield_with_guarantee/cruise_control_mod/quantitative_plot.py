...
sns.boxplot(x='time delay', y='min distance', data=df, order=None, hue='Threshold', ax=ax)
ax.set_xticklabels(['Constant\nDelay: 0','Constant\nDelay: 1','Constant\nDelay: 2','Constant\nDelay: 3','Random\nDelay: 3(max)'])
ax.legend(ncol=6, frameon=False, title='Threshold',loc='upper center',bbox_to_anchor=(0.5,1.25), alignment='left',
