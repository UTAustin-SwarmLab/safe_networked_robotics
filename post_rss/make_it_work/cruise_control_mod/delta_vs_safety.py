...
for delta in delta_values:
    ...
    min_safety_values.append(min_safety)
    act_safety_values.append(actual_safety)

import matplotlib.pyplot as plt 

plt.plot(delta_values, min_safety_values, label='minimum safety guarantee')
plt.plot(delta_values, act_safety_values, label='actual safety guarantee')
...
plt.title('delta vs safety')

# Display the plot
plt.savefig('constant_generated/delta_vs_safety_%d_td.png' % td)